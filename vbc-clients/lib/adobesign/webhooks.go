...
func (s *WebhookService) Webhooks(ctx context.Context) (interface{}, error) {
	req, err := s.client.NewRequest("GET", webhooksPath, nil)
	if err != nil {
		return nil, err
	}
...
// 3609cc55-127f-46eb-baa8-a672ce15d5a4
func (s *WebhookService) DeleteWebhook(ctx context.Context, webhookId string) (interface{}, error) {
	req, err := s.client.NewRequest("DELETE", webhooksPath+"/"+webhookId, nil)
	if err != nil {
		return nil, err
	}
